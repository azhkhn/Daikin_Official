...
class SetDashBoardData extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return FutureBuilder(
        future: (dashboardglobaldata.isEmpty == true) || (dashboardglobaldata.isNotEmpty == true) ? createdashboarddata(dashboardata) : updatedashboarddata(dashboardata) ,
        builder: (BuildContext context, AsyncSnapshot snapshot) {
          ...
          switch (snapshot.connectionState) {
            case ConnectionState.done:
              if (snapshot.hasData) {
                (dashboardglobaldata.isEmpty == true) || (dashboardglobaldata.isNotEmpty == true)
